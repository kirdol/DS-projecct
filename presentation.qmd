...
<h2 style="font-size: 16px;">Correlation between COVID-19 variables and the SDG goals with 1 year gap</h2>
:::

::: {.column width="100%" style="margin-top: -60px;"}
<img src="Covid-Goal-9-Cases.png" height="180px" width="520" style="display: block; margin: 65px auto 0;"/>
<h2 style="font-size: 16px;">Regressions for the Goal 9 with Cases per million variable in the COVID-19 dataset</h2>
:::
:::
