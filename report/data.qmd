...
```{r, echo = TRUE, message = TRUE, warning = FALSE, out.width="75%"}
...
We also look at patterns of missing values in the rows and see that except for the two goals with NAs that we discussed earlier, there are not much patterns. 
```{r, echo = TRUE, message = FALSE, warning = FALSE, out.width="100%"}
...
```{r, echo = TRUE, message = FALSE, warning = FALSE, out.height="75%"}
data_question1 %>%
