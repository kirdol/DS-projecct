...
# # Reshape the data
# melted_data_distribution = Correlation_overall.melt(id_vars=['population', 'overallscore'], 
#                         value_vars=['goal1', 'goal2', 'goal3', 'goal4', 'goal5', 'goal6', 'goal7', 'goal8', 'goal9', 'goal10', 'goal11', 'goal12', 'goal13', 'goal14', 'goal15', 'goal16', 'goal17'],
#                         var_name='Goal', value_name='Score')
# 
# # Plotting
# ggplot(melted_data_distribution, aes(x='Score', y='Goal', fill='Score')) + \
#     geom_density_ridges_gradient(scale=3, size=0.3, rel_min_height=0.01) + \
#     scale_fill_viridis_c(name='Score', option='C') + \
#     labs(title='Goal Scores Distribution')
```
