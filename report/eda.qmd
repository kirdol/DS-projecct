...
Using our cleandata set, first want to observe how ech of our variable are correlated with the other. For that, we will use a heatmap. Given that most of our variables are not normally distributed, we will use the Spearman method to calculate the correlation.
