...
skewness_values <- sapply(Correlation_overall_skew, skewness)
...
new_skewness_values <- sapply(Correlation_overall_skew[highly_skewed_vars], skewness)
new_skewness_values_sqrt <- sapply(Correlation_overall_sqrt[highly_skewed_vars_sqrt], skewness)
...
cor_matrix <- cor(Correlation_overall_skew, use = "everything")
