...
### Model selection for each goal using regsubset() function, forward method ###
...
```{r, echo = TRUE, message = FALSE, warning=FALSE, out.height="100%", out.width="100%"}
### Coefficient plot (positive values only) ###

# Filter estimates superior to 0
...
### Coefficient plot (negative values only) ###

# Filter estimates inferior to 0
df_tidy_positive_n <-
...
# Plot only negative coefficients
