...
```{r, echo = TRUE, message = FALSE, warning=FALSE, cache = TRUE, fig.height=2.5}
...
plot2 <- ggplot(data2) +
  ...
  theme(legend.position = "right", plot.title = element_text(hjust=0.5, size= 10), axis.title.x = element_text(size= 8), axis.title.y = element_text(size= 8), legend.text = element_text(size= 8),legend.title = element_text(size= 10))
...
plot3 <- ggplot(data3) +
  ...
  theme(legend.position="none",plot.title = element_text(hjust=0.5, size= 10), axis.title.x = element_text(size= 8), axis.title.y = element_text(size= 8), legend.text = element_text(size= 8),legend.title = element_text(size= 10))
...
ggplot(data = data5) +
  ...
  theme_light() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, size = 6), plot.title = element_text(hjust=0.5, size=10))
```
