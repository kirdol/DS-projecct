---
title: "How has the adoption of the SDGs in 2015 influenced the achievement of SDGs?"
...
Top 10 countries in term of amelioration each year
...
plots <- lapply(seq_along(unique_years), function(i) {
  ...
  plot_ly() %>%
    add_trace(
      ...
      colors = "viridis",
      showlegend = ifelse(i==1, TRUE, FALSE)  # Disable individual legend for each subplot
    ) %>%
    layout(
...
Worse 10 countries in term of amelioration each year
