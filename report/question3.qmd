...
<img src="Climate_Dis_year_gap.png" height="190px" width="520" style="display: block; margin: 60px auto 0;"/>
...
generate_lagged_correlation_plot_covid <- function(year, data, relevant_columns) {
  ...
  # Create the ggplot
  p <- ggplot(cor_melted, aes(Variable2, Variable1, fill = Correlation)) +
    geom_tile() +
    ...
    theme(axis.text.x = element_text(angle = 45, size = 7, hjust = 1),
          ...
          legend.text = element_text(size = 6)) +
    coord_fixed() +
    labs(x = '', y = '', title = paste('Lagged Correlation for COVID-19 in Year', year))

  return(p)
}

# Generate and display the plots for 2020, 2021, and 2022
plot_2020 <- generate_lagged_correlation_plot_covid(2020, Q3.2, relevant_columns)
plot_2021 <- generate_lagged_correlation_plot_covid(2021, Q3.2, relevant_columns)
plot_2022 <- generate_lagged_correlation_plot_covid(2022, Q3.2, relevant_columns)
...
```{r, echo = TRUE, message = FALSE, warning = FALSE, fig.height = 2, out.width="100%"}
library(plotly)
library(dplyr)
library(ggplot2)
